...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['login'])) {
    ...
    if ($data && $data['password']==$password) {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'pathumwannige@gmail.com'; //host email 
        $mail->Password = 'ldzn guch gtec dlti'; // app password of your host email
        $mail->Port = 465;
        $mail->SMTPSecure = 'ssl';
        $mail->isHTML(true);
        $mail->setFrom('pathumwannige@gmail.com', 'PHP Junior Project');//Sender's Email & Name
